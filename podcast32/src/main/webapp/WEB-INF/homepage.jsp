...
<body>
	...
	<section class="vh-100"
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">PODCAST7 Top Rated</a>
				<button class="navbar-toggler" type="button"
					data-bs-toggle="collapse" data-bs-target="#navbarText"
					aria-controls="navbarText" aria-expanded="false"
					aria-label="Toggle navigation">
				...
				<div class="col">
					<table class="table myTable">
						<c:forEach var="podcast" items="${ allPodcasts }">
							<tr>
								<td><h3>
										<a href="/podcasts/${podcast.id}"><c:out
												value="${ podcast.podcastName }"></c:out></a>
									</h3></td>
								<td><p>
										<c:out value="${ podcast.genre }"></c:out>
									</p></td>
								<td><p>
										HOSTED By :
										<c:out value="${podcast.podcastHost }"></c:out>
									</p></td>
							</tr>
						</c:forEach>
					</table>
