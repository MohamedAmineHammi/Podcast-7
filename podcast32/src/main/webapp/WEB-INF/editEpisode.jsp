...
<head>
<meta charset="UTF-8">
<title>Update Episode &#9827; Poadcast 7 &#9827;</title>
...
<body>
	...
	<section class="vh-100"
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">EDIT Episode <c:out
						value="${episode.episodeTitle }"></c:out>
				</a>
				<button class="navbar-toggler" type="button"
					data-bs-toggle="collapse" data-bs-target="#navbarText"
					aria-controls="navbarText" aria-expanded="false"
		...
		<div class="myContainer">
			<form:form class="newForm"
				action="/podcasts/${podcast.id }/episodes/${ originalEpisode.id }/edit"
				method="POST" modelAttribute="updatedEpisode"
				...
				<div class="formGroup2">
					<form:label path="episodeTitle">TITLE : </form:label>
					<form:input path="episodeTitle"
						value="${originalEpisode.episodeTitle }" />
					<form:errors class="errors" path="episodeTitle" />
				</div>
				<div class="formGroup2">
					<form:label path="episodeDescription">DESCRIPTION : </form:label>
				...
				<div class="formGroup2">
					<form:input type="hidden" path="podcast"
						value="${originalEpisode.podcast.id }" />
				</div>
