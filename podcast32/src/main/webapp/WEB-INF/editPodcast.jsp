...
<head>
<meta charset="UTF-8">
<title>Update <c:out value="${podcast.podcastName }" /> &#9827;
	Poadcast 7 &#9827;
</title>
...
<body>
	...
	<section class="vh-100"
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">UPDATE <c:out
						value="${podcast.podcastName }" /></a>
				<button class="navbar-toggler" type="button"
					data-bs-toggle="collapse" data-bs-target="#navbarText"
					aria-controls="navbarText" aria-expanded="false"
					aria-label="Toggle navigation">
		...
		<div class="myContainer">
			<form:form class="newForm" action="/podcasts/${podcast.id}/edit"
				method="POST" modelAttribute="updatedPodcast"
				...
				<div class="formGroup2">
					<form:input type="hidden" path="creator"
						value="${originalPodcast.creator.id}" />
				</div>
