...
<head>
<meta charset="UTF-8">
<title>New Episode &#9827; Poadcast 7 &#9827;</title>
...
<body>
	...
	<section class="vh-100"
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">ADD Episode To <c:out
		...
		<div class="myContainer">
			...
			<form:form class="newForm"
				action="/podcasts/${podcast.id }/episodes/add" method="POST"
				modelAttribute="newEpisode" enctype="multipart/form-data"
				...
				<div class="formGroup2">
					<form:input type="hidden" path="episodeURL"
						value="${newEpisode.episodeURL } " />
				</div>
				<div class="formGroup2">
					<label>UPLOAD (.mp3) : </label> <input type="file" name="file"
						accept="audio/mpeg" />
